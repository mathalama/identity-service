...
import dev.mathalama.identityservice.service.impl.AuthServiceImpl;
...
class AuthServiceImplTest {
    ...
    void registerUsers_shouldSaveUser_whenRoleExists() {
        ...
        authServiceImpl.register(username, email, password);
    ...
    void assignRoleToUser_shouldAddRole_whenUserAndRoleExist() {
        ...
        authServiceImpl.assignRoleToUser(username, roleName);
