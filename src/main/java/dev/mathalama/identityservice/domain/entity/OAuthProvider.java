...
/**
 * OAuthProvider entity to track OAuth2 provider connections to users.
...
public class OAuthProvider {
     ...
     */
    public OAuthProvider(Users user, String providerName, String providerId, String providerEmail) {
        this.user = user;
     ...
     * Used to track when users last authenticated via each provider for analytics
